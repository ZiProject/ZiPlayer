...
export const generatedApiContent = {
	...
	playerevents: {
		title: "PlayerEvents",
		description:
			"/** Emitted when all filters are cleared */ filtersCleared: [player: Player]; //extension events lyricsCreate: [player: Player, track: Track, lyrics: any]; lyricsChange: [player: Player, track: Track, lyrics: any]; voiceCreate: [player: Player, evt: any]; stats: [stats: PlayerStats]; streamError: [error: Error, track: Track | null]; }",
		summary: "",
