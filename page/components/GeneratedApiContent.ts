...
export const generatedApiContent = {
	...
	playermanageroptions: {
		...
		description:
			"Audio filters configuration. When provided, these filters will be applied to all audio streams played by this player. - Provide filter names (string) to use predefined filters - Or provide AudioFilter objects for custom filters - Multiple filters can be combined /",
		summary: "",
	...
	voicechannel: {
		title: "VoiceChannel",
		description:
			'/** Seek position in milliseconds to start saving from */ seek?: number; } export type LoopMode = "off" | "track" | "queue";',
		summary: "",
	...
	playerevents: {
		title: "PlayerEvents",
		description:
			"/** Emitted when all filters are cleared */ filtersCleared: [player: Player]; //extension events lyricsCreate: [player: Player, track: Track, lyrics: any]; lyricsChange: [player: Player, track: Track, lyrics: any]; voiceCreate: [player: Player, evt: any]; }",
		summary: "",
