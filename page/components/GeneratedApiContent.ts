...
export const generatedApiContent = {
	playermanager: {
		...
		methods: [
			...
			},
			{
				...
				description:
					"Search using PluginManager without creating a Player. Uses the same search pipeline as Player.search(): - cache - plugin deduplication - plugin scoring/evaluation - fallback handling /",
				example: "",
				code: "",
				parameters: [
					{
	...
	searchscore: {
		...
		description: "Contains search results from plugins, including tracks and optional playlist information.",
		summary: "",
		badges: ["interface", "core", "searchscore"],
		code: 'const result: SearchResult = {\n  tracks: [\n    {\n      id: "track1",\n      title: "Song 1",\n      url: "https://example.com/track1",\n      duration: 180000,\n      requestedBy: "user123",\n      source: "youtube"\n    }\n  ],\n  playlist: {\n    name: "My Playlist",\n    url: "https://example.com/playlist",\n    thumbnail: "https://example.com/thumb.jpg"\n  }\n};',
		methods: [],
		events: [],
		properties: [],
	...
	trackmiddlewarecontext: {
		...
		summary: "",
		badges: ["interface", "extension", "trackmiddlewarecontext"],
	...
	playermanageroptions: {
		...
		description:
			"Chain of middleware applied to every track immediately before stream extraction (after queueing). Merged after {@link PlayerManagerOptions.trackMiddleware} from the manager. /",
		summary: "",
	...
	saveoptions: {
		...
		summary: "",
		badges: ["interface", "core", "saveoptions"],
	...
	playersession: {
		...
		summary: "",
		badges: ["interface", "core", "playersession"],
	...
	preloadstate: {
		title: "PreloadState",
		description:
			"/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; }",
		summary: "",
		badges: ["interface", "core", "preloadstate"],
	...
	forwardhealthstatus: {
		...
		description:
			"/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; }",
		summary: "",
		badges: ["interface", "core", "forwardhealthstatus"],
	...
	playerstats: {
		...
		summary: "",
		badges: ["interface", "core", "playerstats"],
	...
	streamslot: {
		...
		summary: "",
		badges: ["interface", "core", "streamslot"],
	...
	voicechannel: {
		...
		summary: "",
		badges: ["interface", "core", "voicechannel"],
	...
	managerevents: {
		...
		summary: "",
		badges: ["interface", "core", "managerevents"],
