...
export const generatedApiContent = {
  ...
  "streamslot": {
    "title": "StreamSlot",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; } export interface PlayerStats { totalPlayers: number; activePlayers: number; pausedPlayers: number; connectedPlayers: number; totalTracksInQueue: number; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
  ...
  "voicechannel": {
    "title": "VoiceChannel",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; } export interface PlayerStats { totalPlayers: number; activePlayers: number; pausedPlayers: number; connectedPlayers: number; totalTracksInQueue: number; } export interface StreamSlot { resource: AudioResource | null; track: Track | null; streamId: string | null; abortController: AbortController | null; isValid: boolean; isLoading: boolean; loadPromise: Promise<void> | null; } export type LoopMode = \"off\" | \"track\" | \"queue\";",
    "summary": "",
    "badges": [
      "interface",
      "core",
