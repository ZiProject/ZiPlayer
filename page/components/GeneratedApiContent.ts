...
export const generatedApiContent = {
  ...
  "audiofilter": {
    "title": "AudioFilter",
    "description": "Audio filter configuration for applying effects to audio streams. Based on FFmpeg audio filters for Discord music bots.",
    "summary": "",
    "badges": [
      "interface",
      "core",
