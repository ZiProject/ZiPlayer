...
export const generatedApiContent = {
  "playermanager": {
    ...
    "methods": [
      ...
      },
      {
        ...
        "description": "Search using PluginManager without creating a Player. Uses the same search pipeline as Player.search(): - cache - plugin deduplication - plugin scoring/evaluation - fallback handling /",
        "example": "",
        "code": "",
        "parameters": [
          {
  ...
  "managercacheentry": {
    ...
    "description": "The ManagerCacheEntry interface",
    "summary": "",
    "badges": [
      "interface",
      "core",
  ...
  "queue": {
    ...
    "methods": [
      ...
      },
      {
        ...
        "description": "Check if a track exists in the queue /",
        "example": "",
        "code": "",
        "parameters": [
          {
        ...
        "returns": {
          "type": "boolean",
          "description": "True if track exists"
        }
      }
    ],
    "events": [],
  ...
  "trackmiddlewarecontext": {
    "title": "TrackMiddlewareContext",
    "description": "/** Passed to each {@link TrackMiddleware} run (before stream resolution). */",
    "summary": "",
    "badges": [
      "interface",
      "extension",
    ...
    "code": "// TrackMiddlewareContext usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "playermanageroptions": {
    ...
    "description": "Chain of middleware applied to every track immediately before stream extraction (after queueing). Merged after {@link PlayerManagerOptions.trackMiddleware} from the manager. /",
    "summary": "",
    "badges": [
      "interface",
      "core",
  ...
  "saveoptions": {
    "title": "SaveOptions",
    "description": "Options for saving tracks",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "const options: SaveOptions = {\n  filename: \"my-song.mp3\",\n  quality: \"high\",\n  timeout: 30000\n};",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "playersession": {
    "title": "PlayerSession",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// PlayerSession usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "preloadstate": {
    "title": "PreloadState",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// PreloadState usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "forwardhealthstatus": {
    "title": "ForwardHealthStatus",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// ForwardHealthStatus usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "playerstats": {
    "title": "PlayerStats",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; } export interface ForwardHealthStatus { guildId: string; healthy: boolean; role: \"leader\" | \"follower\" | \"none\"; issues: string[]; details: { leaderId?: string; followerCount?: number; connectionState?: string; audioPlayerState?: string; }; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// PlayerStats usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": [],
  ...
  "streamslot": {
    "title": "StreamSlot",
    "description": "/** Seek position in milliseconds to start saving from */ seek?: number; } export interface PlayerSession { guildId: string; queue: Track[]; currentTrack: Track | null; volume: number; loopMode: LoopMode; autoPlay: boolean; position: number | null; extensions: string[]; plugins: string[]; userdata?: Record<string, any>; } export interface PreloadState { resource: AudioResource | null; track: Track | null; abortController: AbortController | null; timeoutId: NodeJS.Timeout | null; isValid: boolean; streamId?: string; isBeingUsed: boolean; } export interface ForwardHealthStatus { guildId: string; healthy: boolean; role: \"leader\" | \"follower\" | \"none\"; issues: string[]; details: { leaderId?: string; followerCount?: number; connectionState?: string; audioPlayerState?: string; }; } export interface PlayerStats { totalPlayers: number; leader: number; follower: number; activePlayers: number; pausedPlayers: number; connectedPlayers: number; totalTracksInQueue: number; forwardHealthStatus: ForwardHealthStatus[]; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
  ...
  "voicechannel": {
    "title": "VoiceChannel",
    "description": "The VoiceChannel interface",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// VoiceChannel usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": []
  ...
  "managerevents": {
    "title": "ManagerEvents",
    "description": "The ManagerEvents interface",
    "summary": "",
    "badges": [
      "interface",
      "core",
    ...
    "code": "// ManagerEvents usage example",
    "methods": [],
    "events": [],
    "properties": [],
    "params": []
  ...
  "playerevents": {
    "title": "PlayerEvents",
    "description": "/** Emitted when all filters are cleared */ filtersCleared: [player: Player]; //extension events lyricsCreate: [player: Player, track: Track, lyrics: any]; lyricsChange: [player: Player, track: Track, lyrics: any]; voiceCreate: [player: Player, evt: any]; stats: [stats: PlayerStats]; streamError: [player: Player, error: Error, track: Track | null]; forwardModeStart: [player: Player, leader: Player]; forwardModeEnd: [player: Player, leader: Player, reason: string | undefined]; }",
    "summary": "",
    "badges": [
      "interface",
      "core",
  ...
  "youtubeplugin": {
    ...
    "methods": [
      ...
      },
      {
        ...
        "description": "Retrieves the audio stream for a YouTube track using sabr download. This method extracts the audio stream from a YouTube video using the sabr download method which provides better quality and more reliable streaming.",
