...
export class Player extends EventEmitter {
	...
	public get upcomingTracks(): Track[] { return this.queueController?.snapshot?.() ?? []; }
	public get previousTracks(): Track[] { return this.queue?.previousTracks ?? []; }
	public get availablePlugins(): BasePlugin[] { return this.pluginManager?.getAll?.() ?? []; }
	public get relatedTracks(): Track[] | null { return this.queueController?.relatedTracks ?? null; }
	public get currentResource() { return this.playbackController.activeResource ?? null; }
	...
	public getCachedSearchResult(query: string): SearchResult | null { return this.searchController.cache?.get?.(query.toLowerCase().trim()) ?? null; }
	public cacheSearchResult(query: string, result: SearchResult): void { this.searchController.cacheResult(query, result); }
	public clearExpiredSearchCache(): void { this.searchController.purgeStale(); }
