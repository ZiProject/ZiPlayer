...
export class ForwardController {
 ...
 constructor(private readonly player: Player, options: ForwardControllerOptions = {}) { this.debug = options.debug ?? (() => undefined); }
 ...
 dispose(): void { if (this.disposed) return; this.disposed = true; this.clearFollowers(); this.unsubscribeForward("controller disposed"); }
}
